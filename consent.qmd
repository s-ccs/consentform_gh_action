...
`{python} fmt(toml['Consentform']['researcher_details_de'])`
:::
::: {.content-visible when-profile="en"}
`{python} fmt(toml['Consentform']['researcher_details_en'])`
:::
::::
...
```{python} 
ifno(toml['Consentform']['use_eeg'], fmt(":::: {.content-hidden}"))
```
::: {.content-visible when-profile="de"}
...
:::
```{python}
ifno(toml['Consentform']['use_eeg'], fmt("::::"))
```



```{python}
ifno(toml['Consentform']['use_eyetracking'], fmt(":::: {.content-hidden}"))
```
::: {.content-visible when-profile="de"}
...
:::
```{python}
ifno(toml['Consentform']['use_eyetracking'],fmt("::::"))
```
